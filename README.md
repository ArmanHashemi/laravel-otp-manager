...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/ArmanHashemi/laravel-otp-manager.svg?style=flat-square)](https://packagist.org/packages/ArmanHashemi/laravel-otp-manager)
[![Total Downloads](https://img.shields.io/packagist/dt/ArmanHashemi/laravel-otp-manager.svg?style=flat-square)](https://packagist.org/packages/ArmanHashemi/laravel-otp-manager)
[![GitHub Actions](https://img.shields.io/github/actions/workflow/status/ArmanHashemi1992/laravel-otp-manager/run-tests.yml?branch=main&label=tests)](https://github.com/ArmanHashemi1992/laravel-otp-manager/actions/workflows/run-tests.yml)
[![GitHub Actions](https://img.shields.io/github/actions/workflow/status/ArmanHashemi1992/laravel-otp-manager/static-analysis.yml?branch=main&label=static-analysis)](https://github.com/ArmanHashemi1992/laravel-otp-manager/actions/workflows/static-analysis.yml)
[![codecov](https://codecov.io/gh/ArmanHashemi1992/laravel-otp-manager/graph/badge.svg?token=EJB78FT27M)](https://codecov.io/gh/ArmanHashemi1992/laravel-otp-manager)
...
```bash
composer require ArmanHashemi/laravel-otp-manager
```
## Usage

### Sending OTP
```php
use ArmanHashemi\OtpManager\Facade\OtpManager;
...
```php
protected $listen = [
    \ArmanHashemi\OtpManager\Events\OtpPrepared::class => [
...
```php
use ArmanHashemi\OtpManager\Events\OtpPrepared;
...
```bash
php artisan vendor:publish --provider="ArmanHashemi\OtpManager\OtpManagerServiceProvider" --tag="config"
```
To publish the language files, run:
```bash
php artisan vendor:publish --provider="ArmanHashemi\OtpManager\OtpManagerServiceProvider" --tag="lang"
```
...
- [ArmanHashemi](https://github.com/ArmanHashemi)
