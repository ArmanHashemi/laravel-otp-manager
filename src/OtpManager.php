...
namespace ArmanHashemi\OtpManager;

use Illuminate\Support\Carbon;
use Illuminate\Support\Str;
use Illuminate\Validation\ValidationException;
use ArmanHashemi\ConfigurableCache\ConfigurableCache;
...
class OtpManager
{
     ...
     * @param  \ArmanHashemi\OtpManager\Contracts\OtpTypeInterface|null  $type  The type or category of OTP being sent (e.g., 'login', 'reset_password').
     * @return \ArmanHashemi\OtpManager\Dto\SentOtpDto An object containing details of the sent OTP.
     *
     ...
     * @param  \ArmanHashemi\OtpManager\Contracts\OtpTypeInterface|null  $type  The type or category of OTP (e.g.,
     ...
     *
     * @param  string  $mobile  The mobile number associated with the OTP.
     * @param  \ArmanHashemi\OtpManager\Contracts\OtpTypeInterface|null  $type  The type or category of OTP (e.g., 'login', 'reset_password').
     * @return \ArmanHashemi\OtpManager\Dto\OtpDto|null An OtpDto object containing the OTP code and tracking code, or null if not found.
     */
